...
All non-deferred dispatch steps complete: substrate (store/rollout/cheat_oracle/proposer/optimize), baited corpora, calibration, reproduction run (experiments/001), and held-out transfer (experiments/002) are built, verified, and committed.
