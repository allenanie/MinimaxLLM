...
- [ ] `scripts/bench_modal.py`: benchmark harbor-on-modal speed, throughput, price, and concurrency scaling; plan is the "Modal throughput bench" section of the 002 dispatch; spend is pre-approved (2026-07-31), so it runs beside step 0.
