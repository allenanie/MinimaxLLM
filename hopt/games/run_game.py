...
def build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--val-frac", type=float, default=0.30,
                   help="fraction of that budget held as val. Val carries every "
                   "r_d and r* comparison, so at 6 tasks those numbers swing 0.17 "
                   "per task -- this is the knob that makes them readable.")
    p.add_argument(
        "--static-detector",
        action="store_true",
